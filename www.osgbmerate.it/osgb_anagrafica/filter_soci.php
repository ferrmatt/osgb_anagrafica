    ...
    <body>
        <form name = "myform" method = "post" >
            <table border = "0" cellspacing = "5" cellpadding = "5" >
                <tr> <td> Nome: </td><td><input type="text" onblur="run()" name="nome" <?php
                        if (isset($_POST['nome']) && $_POST['nome'] != '') {
                            echo "value=" . $_POST['nome'];
                        }
                        ?> onchange="this.value = this.value.toUpperCase()" size="20" ></td > </tr>
                <tr> <td> Cognome: </td><td><input type="text" onblur="run()" name="cognome" <?php
