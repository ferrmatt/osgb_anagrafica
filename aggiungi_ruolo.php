...
?>
                            ...
                            if (isset($_POST['quota']) && $_POST['quota'] == 'Altro') {
                                if (isset($_POST['quota_libera'])) {
                                    echo "<td>Altro: </td><td><input type=\"text\" name=\"quota_libera\" value=\"".$_POST['quota_libera']."\" onchange=\"run()\" size=\"4\" onblur=\"this.value = this.value.toUpperCase()\"></td>";
                                } else {
