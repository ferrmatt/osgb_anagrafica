...
<html>
    ...
    <body>
        ...
        <form name="libro_soci_form" method="post">
            ...
            <input type="button" value="Visualizza Libro Soci" onClick="window.location.href = 'query_libro_soci.php?anno_sociale=<?php echo $_POST['anno_sociale']; ?>&maggiorenni=<?php if (isset($_POST['maggiorenni'])){echo "true";}else{echo "false";}  ?>&giorno=<?php if (isset($_POST['giorno'])){echo $_POST['giorno'];}else{echo $day;} ?>&mese=<?php if (isset($_POST['mese'])){echo $_POST['mese'];}else{echo $month_str;} ?>&anno=<?php if (isset($_POST['anno'])){echo $_POST['anno'];}else{echo $year;} ?>'">            
